...
<head>
    ...
    <link rel="icon" type="image/x-icon" style="border-radius: 50%!important;" href="${pageContext.request.contextPath}/images/favicon.ico">
...
<header>
    ...
    <div class="container">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/">
            <img src="${pageContext.request.contextPath}/images/olskercupcakes.png" class="img-fluid w-100"/>
        </a>
    </div>
    <div class="container">
        <%--        </div>--%>
